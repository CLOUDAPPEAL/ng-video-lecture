...
n_head = 6 # batch_size * n_head = n_embd
n_layer = 6
dropout = 0.2
# ------------
...
with open('/Users/iceplus/Desktop/project/GPT_from_scratch/ng-video-lecture/input.txt', 'r', encoding='utf-8') as f:
    text = f.read()
...
class Head(nn.Module):
    def __init__(self, head_size):
        ...
        self.register_buffer('tril', torch.tril(torch.ones(block_size, block_size))) # 属性名为tril的下三角矩阵
